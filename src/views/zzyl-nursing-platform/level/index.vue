    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          icon="Plus"
          @click="handleAdd"
          v-hasPermi="['zzyl-nursing-platform:level:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['zzyl-nursing-platform:level:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['zzyl-nursing-platform:level:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['zzyl-nursing-platform:level:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="levelList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['zzyl-nursing-platform:level:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['zzyl-nursing-platform:level:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
import { listLevel, getLevel, delLevel, addLevel, updateLevel } from "@/api/zzyl-nursing-platform/level";
...
function handleExport() {
  proxy.download('zzyl-nursing-platform/level/export', {
    ...queryParams.value
